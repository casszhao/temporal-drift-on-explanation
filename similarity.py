...
def cosine_similarity(repr1, repr2):
    ...
    sim = scipy.spatial.distance.cosine(repr1, repr2)
    # () Values range between -1 and 1, where -1 is perfectly dissimilar and 1 is perfectly similar. when without 1-cosine
    # scipy.spatial.distance.cosine already do 1-cosine
    # so bigger angle, smaller cosine, bigger 1-cosine, bigger value, bigger diverge
    if np.isnan(sim):
