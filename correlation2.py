...
if args.combine_all:
    ...
    for task in task_list:
        ...
        #df2 = pd.read_csv('./saved_everything/'+str(task)+'/corre_table_non.csv')[['AsyD1', 'AsyD2']].T
        #print(df2)
        df.columns = ['Suff Diff','Comp Diff','Temp Diff','Topic Diff', 'Text len']
        # print(df)
        # df2.columns = ['Suff changes','Comp changes']
        # df['Suff changes'] = df2['Suff changes']
        # df['Comp changes'] = df2['Comp changes']
        # df['Task'] = str(task)
        # print(df)
    ...
    df = pd.read_csv('./saved_everything/all_tasks_all_factors_onlyAysD.csv')[['Suff Diff','Comp Diff','Temp Diff','Topic Diff', 'Text len']] # ,'Sent Div'
    print(df)
    print('+============')
...
suff_diff_1 = suff_In - suff_ood1
suff_diff_2 = suff_In - suff_ood2
comp_diff_1 = comp_In - comp_ood1
comp_diff_2 = comp_In - comp_ood2
